...
const benefits = [
  { icon: Search, title: "Диагностика HR-процессов", desc: "Оценим найм, адаптацию, мотивацию, удержание и развитие" },
  ...
  { icon: ShieldCheck, title: "Честный подход", desc: "Рекомендуем только то, что реально нужно вашей компании" },
];
...
const BenefitsSection = () => (
  <section id="benefits" className="relative py-24 sm:py-32 section-divider">
    <div className="section-container relative">
      ...
      >
        <span className="badge-pill mb-6">Что входит в аудит</span>
        <h2 className="text-3xl sm:text-5xl font-display font-bold text-foreground mb-5 tracking-tight">
          Что вы получите
        </h2>
        <p className="text-muted-foreground max-w-xl mx-auto text-lg">
          Полная картина HR-ситуации вашей компании и понятный план действий
        </p>
      </motion.div>
